  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    PortfolioContext.Provider,
    {
      value: {
        ...
        setLang,
        theme,
        toggleTheme: () => setTheme((t2) => t2 === "dark" ? "light" : "dark"),
...
const Languages$1 = createLucideIcon("languages", __iconNode$9);
const __iconNode$8 = [
  [
    "path",
    {
...
const profileImg = "/assets/profile-D4RrViwT.jpg";
const expStc = "/assets/exp-stc--29Xaiqk.jpg";
const expKaust = "/assets/exp-kaust-DLEVVvU2.jpg";
const expNaseej = "/assets/exp-naseej-iw3FlkZQ.jpg";
const projSeen = "/assets/proj-seen-CgpYC_59.jpg";
const projMaher = "/assets/proj-maher-DDh7iy2d.jpg";
const projYolo = "/assets/proj-yolo-B7HtSeC3.jpg";
const projEdutwin = "/assets/proj-edutwin-DEnSqnEu.jpg";
const projTomato = "/assets/proj-tomato-DiN-jwnF.jpg";
const projBees = "/assets/proj-bees-BmQcWefz.jpg";
const projMuthmirah = "/assets/proj-muthmirah-IhxtSczb.jpg";
const award1st = "/assets/award-1st-D5U8AzLf.jpg";
const awardHack = "/assets/proj-muthmirah-IhxtSczb.jpg";
const awardTop11 = "/assets/award-1st-D5U8AzLf.jpg";
const ASSETS = {
  profile: profileImg
};
const CV_URL = "/cv/Abdulrahman_Dawshi_CV.pdf";
const experiences = [
  {
    ...
    motion.header,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 md:px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#top", className: "flex items-center gap-2 font-display text-lg font-bold", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-9 w-9 place-items-center rounded-lg gradient-hero text-primary-foreground shadow-glow", children: "AD" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline text-gradient", children: "Dawshi" })
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Languages$1, { className: "h-4 w-4" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sr-only", children: "Toggle language" })
                ]
              }
            ),
        ...
        open && /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.nav,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1 p-4", children: [
...
function Hero() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "top", className: "relative overflow-hidden pt-28 pb-20 md:pt-36 md:pb-28", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 grid-bg opacity-50", "aria-hidden": true }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-40 -right-40 h-96 w-96 rounded-full gradient-hero opacity-20 blur-3xl animate-float", "aria-hidden": true }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-40 -left-40 h-96 w-96 rounded-full gradient-hero opacity-20 blur-3xl animate-float", "aria-hidden": true }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto grid max-w-7xl gap-10 px-4 md:grid-cols-[1.2fr_1fr] md:items-center md:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "mt-4 font-display text-4xl font-bold leading-tight md:text-6xl", children: [
              ...
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: name.split(" ").slice(-1) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 max-w-xl text-base text-muted-foreground md:text-lg", children: tt.hero.tagline }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex flex-wrap gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: CV_URL, download: true, className: "inline-flex items-center gap-2 rounded-xl gradient-hero px-5 py-3 text-sm font-medium text-primary-foreground shadow-glow hover:opacity-90 transition", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "h-4 w-4" }),
                tt.hero.cta
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#contact", className: "inline-flex items-center gap-2 rounded-xl border border-border bg-card px-5 py-3 text-sm font-medium hover:bg-muted transition", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "h-4 w-4" }),
                tt.hero.contact
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex flex-wrap gap-4 text-sm text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-4 w-4" }),
                loc
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: profile.github, target: "_blank", rel: "noreferrer", className: "inline-flex items-center gap-1.5 hover:text-foreground transition", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Github, { className: "h-4 w-4" }),
                "GitHub"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: profile.linkedin, target: "_blank", rel: "noreferrer", className: "inline-flex items-center gap-1.5 hover:text-foreground transition", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 -m-6 rounded-full gradient-hero opacity-30 blur-2xl animate-glow-pulse", "aria-hidden": true }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative h-64 w-64 overflow-hidden rounded-full border-4 border-primary/30 shadow-glow md:h-80 md:w-80", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: ASSETS.profile, alt: name, className: "h-full w-full object-cover" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
                animate: { rotate: 360 },
...
function Section({ id: id2, title, children, eyebrow }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: id2, className: "relative scroll-mt-24 py-16 md:py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 md:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 20 },
        ...
        children: [
          eyebrow && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-[0.2em] text-primary", children: eyebrow }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-2 font-display text-3xl font-bold md:text-4xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: title }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto mt-3 h-1 w-16 rounded-full gradient-hero" })
        ]
      }
    ),
    children
...
function About() {
  const { lang } = usePortfolio();
  const tt = t[lang];
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "about", title: tt.sections.about, eyebrow: "01", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      initial: { opacity: 0, y: 20 },
      whileInView: { opacity: 1, y: 0 },
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "glass rounded-2xl p-6 md:p-8 shadow-soft", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base leading-relaxed text-muted-foreground md:text-lg", children: lang === "ar" ? profile.bioAr : profile.bioEn }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass flex flex-col gap-3 rounded-2xl p-6 md:p-8 text-sm shadow-soft", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `mailto:${profile.email}`, className: "flex items-center gap-2 hover:text-primary transition", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "h-4 w-4 text-primary" }),
            profile.email
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `tel:${profile.phone}`, className: "flex items-center gap-2 hover:text-primary transition", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2", children: [
            ...
            lang === "ar" ? profile.locationAr : profile.locationEn
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: profile.github, target: "_blank", rel: "noreferrer", className: "flex items-center gap-2 hover:text-primary transition", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Github, { className: "h-4 w-4 text-primary" }),
            "GitHub"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: profile.linkedin, target: "_blank", rel: "noreferrer", className: "flex items-center gap-2 hover:text-primary transition", children: [
...
function Experience() {
  const { lang } = usePortfolio();
  const tt = t[lang];
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "experience", title: tt.sections.experience, eyebrow: "02", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-6 md:gap-8", children: experiences.map((e, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.article,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: e.image, alt: lang === "ar" ? e.titleAr : e.titleEn, loading: "lazy", className: "h-full w-full object-cover transition duration-500 group-hover:scale-110" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-background/70 to-transparent opacity-0 transition group-hover:opacity-100" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "absolute bottom-3 right-3 inline-flex items-center gap-1 rounded-full bg-primary/90 px-3 py-1 text-xs font-medium text-primary-foreground opacity-0 transition group-hover:opacity-100", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 md:p-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-3 text-xs text-muted-foreground", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1", children: [
              ...
              lang === "ar" ? e.locAr : e.locEn
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-2 font-display text-xl font-semibold", children: lang === "ar" ? e.titleAr : e.titleEn }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm leading-relaxed text-muted-foreground md:text-base", children: lang === "ar" ? e.descAr : e.descEn })
        ] })
      ]
    },
    i
    ...
    motion.a,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-video overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: p.image, alt: lang === "ar" ? p.titleAr : p.titleEn, loading: "lazy", className: "h-full w-full object-cover transition duration-500 group-hover:scale-110" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-background/80 via-transparent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "absolute top-3 right-3 inline-flex items-center gap-1 rounded-full bg-card/80 px-2 py-1 text-[10px] backdrop-blur", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "h-3 w-3" }),
            p.period
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute bottom-3 right-3 inline-flex h-9 w-9 items-center justify-center rounded-full gradient-hero text-primary-foreground opacity-0 transition group-hover:opacity-100", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "h-4 w-4" }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 flex-col p-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-semibold", children: lang === "ar" ? p.titleAr : p.titleEn }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm leading-relaxed text-muted-foreground", children: lang === "ar" ? p.descAr : p.descEn })
        ] })
      ]
    },
    i
...
function Certificates() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "certs", title: tt.sections.certs, eyebrow: "04", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4 grid-cols-2 lg:grid-cols-3 xl:grid-cols-4", children: certificates.map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.a,
    {
      ...
      className: "glass group flex flex-col overflow-hidden rounded-2xl shadow-soft transition hover:shadow-glow",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[16/10] overflow-hidden flex items-center justify-center bg-card/60 p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: c.logo, alt: c.issuer, loading: "lazy", className: "h-full w-full object-contain transition duration-500 group-hover:scale-110" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-primary/20 to-accent/20 mix-blend-overlay" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-3 left-3 inline-flex h-9 w-9 items-center justify-center rounded-full gradient-hero text-primary-foreground shadow-glow", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Award, { className: "h-4 w-4" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "absolute bottom-3 right-3 inline-flex items-center gap-1 rounded-full bg-card/80 px-2 py-1 text-[10px] backdrop-blur opacity-0 transition group-hover:opacity-100", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "h-3 w-3" }),
            " ",
            tt.viewLink
          ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-medium leading-snug", children: lang === "ar" ? c.ar : c.en }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs text-muted-foreground", children: c.issuer })
        ] })
      ]
    },
    i
...
function Skills() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "skills", title: tt.sections.skills, eyebrow: "05", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4 sm:grid-cols-2", children: groups.map((g, gi) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mb-5 font-display text-lg font-semibold text-gradient", children: g.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-4", children: g.items.map((s, si) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-1.5 flex items-center justify-between gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2 text-sm font-medium", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(motion.span, { whileHover: { rotate: 360, scale: 1.2 }, transition: { duration: 0.5 }, className: `grid h-8 w-8 place-items-center rounded-lg bg-muted ${meta.color}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "h-4 w-4" }) }),
                s.name
              ] }),
...
function Awards() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "awards", title: tt.sections.awards, eyebrow: "06", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4 grid-cols-2 md:grid-cols-3", children: awards.map((a, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.a,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-video overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: a.image, alt: lang === "ar" ? a.titleAr : a.titleEn, loading: "lazy", className: "h-full w-full object-cover transition duration-500 group-hover:scale-110" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-background/80 to-transparent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-3 left-3 inline-flex h-10 w-10 items-center justify-center rounded-full gradient-hero text-primary-foreground shadow-glow", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trophy, { className: "h-5 w-5" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "absolute bottom-3 right-3 inline-flex items-center gap-1 rounded-full bg-card/80 px-2 py-1 text-[10px] backdrop-blur opacity-0 transition group-hover:opacity-100", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "h-3 w-3" }),
            " ",
            tt.viewLink
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-1 font-display text-lg font-semibold", children: lang === "ar" ? a.titleAr : a.titleEn }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: lang === "ar" ? a.descAr : a.descEn })
        ] })
      ]
    },
    i
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(motion.span, { whileHover: { rotate: [0, -10, 10, 0] }, transition: { duration: 0.5 }, className: "grid h-12 w-12 place-items-center rounded-xl gradient-hero text-2xl shadow-glow", children: l.flag }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-semibold", children: l.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: l.label })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Languages$1, { className: "h-5 w-5 text-primary" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-1 flex justify-between text-xs text-muted-foreground", children: [
...
function Contact() {
  const { lang } = usePortfolio();
  const tt = t[lang];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { id: "contact", title: tt.sections.contact, eyebrow: "08", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 20 },
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl font-bold md:text-3xl", children: lang === "ar" ? "هيّا نبني شيئًا رائعًا معًا" : "Let's build something great together" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-muted-foreground", children: lang === "ar" ? "متاح للفرص والتعاونات في الذكاء الاصطناعي وتطوير البرمجيات." : "Open to opportunities and collaborations in AI & software development." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 grid gap-3 sm:grid-cols-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `mailto:${profile.email}`, className: "glass flex items-center justify-center gap-2 rounded-xl px-4 py-3 text-sm hover:shadow-glow transition", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "h-4 w-4 text-primary" }),
              profile.email
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `tel:${profile.phone}`, className: "glass flex items-center justify-center gap-2 rounded-xl px-4 py-3 text-sm hover:shadow-glow transition", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "h-4 w-4 text-primary" }),
              profile.phone
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: profile.github, target: "_blank", rel: "noreferrer", className: "glass flex items-center justify-center gap-2 rounded-xl px-4 py-3 text-sm hover:shadow-glow transition", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Github, { className: "h-4 w-4 text-primary" }),
              "GitHub"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: profile.linkedin, target: "_blank", rel: "noreferrer", className: "glass flex items-center justify-center gap-2 rounded-xl px-4 py-3 text-sm hover:shadow-glow transition", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Linkedin, { className: "h-4 w-4 text-primary" }),
              "LinkedIn"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: CV_URL, download: true, className: "mt-8 inline-flex items-center gap-2 rounded-xl gradient-hero px-6 py-3 text-sm font-medium text-primary-foreground shadow-glow hover:opacity-90 transition", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "h-4 w-4" }),
            tt.hero.cta
          ] })
        ]
...
function Index() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PortfolioProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen gradient-soft", children: [
