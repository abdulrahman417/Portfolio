...
const appCss = "/assets/styles-BIw_5iSI.css";
...
const Route$1 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Futuristic portfolio of Abdulrahman Ali Dawshi — AI Software Developer building intelligent, production-ready systems." },
      { name: "author", content: "Abdulrahman Dawshi" },
      { property: "og:title", content: "Abdulrahman Dawshi — AI Software Developer" },
      { property: "og:description", content: "Projects, experience, certificates and awards in AI, ML, and full-stack development." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Space+Grotesk:wght@500;600;700&family=Tajawal:wght@400;500;700&display=swap" }
    ]
  }),
...
const $$splitComponentImporter = () => import("./index-C6pv8yFB.js");
const Route2 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Portfolio of Abdulrahman Ali Dawshi — AI Software Developer at Naseej. Projects, experience, certificates, and awards in AI, ML, and full-stack development."
    }, {
      property: "og:title",
      content: "Abdulrahman Dawshi — AI Software Developer"
    }, {
      property: "og:description",
      content: "Futuristic portfolio showcasing AI projects, experience, and certificates."
    }]
  })
});
