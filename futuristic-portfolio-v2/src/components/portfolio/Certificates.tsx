...
import { certificates, t } from "@/lib/i18n";
    ...
    <Section id="certs" title={tt.sections.certs} eyebrow="04">
      <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {certificates.map((c, i) => (
          ...
          >
            <div className="relative aspect-[16/10] overflow-hidden flex items-center justify-center bg-card/60 p-4">
              <img src={c.logo} alt={c.issuer} loading="lazy" className="h-full w-full object-contain transition duration-500 group-hover:scale-110" />
